...
namespace RPCC.Utils
{
    ...
    {
        public static readonly Transform Trans = new();
        ...
        public static void CalculateObjectDistance2Moon(ObservationTask task)
        {
            ...
            var jd = AstroUtilities.JulianDateUtc;
        ...
        internal static double[] GetRaDecFromAltAz(double az, double el)
        {
            Trans.SetAzimuthElevation(az, el);
            // var ra = Trans.RAJ2000;
            // var dec = Trans.DecJ2000;
            // GoTo(ra, dec, true);
            return new[] {Trans.RAJ2000, Trans.DecJ2000};
        }
    }
}